...
public class HueBridgeSearchActivity extends Activity implements OnItemClickListener {
    ...
    private PHSDKListener listener = new PHSDKListener() {
        ...
        public void onAuthenticationRequired(PHAccessPoint accessPoint) {
            ...
            startActivity(new Intent(HueBridgeSearchActivity.this, HuePushLinkActivity.class));

        }

        @Override
        public void onConnectionResumed(PHBridge bridge) {
            if (HueBridgeSearchActivity.this.isFinishing())
                return;
    ...
    public void doBridgeSearch() {
        PHWizardAlertDialog.getInstance().showProgressDialog(R.string.search_progress, HueBridgeSearchActivity.this);
        PHBridgeSearchManager sm = (PHBridgeSearchManager) phHueSDK.getSDKService(PHHueSDK.SEARCH_BRIDGE);
