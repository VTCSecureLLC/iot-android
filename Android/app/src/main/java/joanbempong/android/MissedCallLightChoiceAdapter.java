 ...
 */
public class MissedCallLightChoiceAdapter extends BaseAdapter {
    ...
    public View getView(final int position, final View convertView, ViewGroup parent) {
        ...
        lightName.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked){
                    controller.addToMissedCallLightsList(light.getName());
                }
                else{
                    controller.removeFromMissedCallLightsList(light.getName());
                }
            }
        });
