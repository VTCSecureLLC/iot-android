 ...
 */
public class DefaultMissedCallLightChoiceAdapter extends BaseAdapter {
     ...
     */
    public DefaultMissedCallLightChoiceAdapter(Context context, List<PHLight> allLights, HueController controller) {
    ...
    public View getView(final int position, final View convertView, ViewGroup parent) {
        ...
        lightName.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked){
                    controller.addToMissedCallDefaultLights(light.getName());
                }
                else{
                    controller.removeFromMissedCallDefaultLights(light.getName());
                }
            }
        });
        return view;
